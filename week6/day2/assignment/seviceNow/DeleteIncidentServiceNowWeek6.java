...
import org.openqa.selenium.WebElement;
	...
	public class  DeleteIncidentServiceNowWeek6 extends BaseClassServiceNowWeek6
	{
	@Test//(enabled=false)
		...
		Thread.sleep(500);
		String deletedIncidentNumber = driver.findElement(By.xpath("(//div[@class='breadcrumb_container']//a)[9]//b")).getText();
		String deletedMessage = driver.findElement(By.xpath("//div[@class='list2_empty-state-list']")).getText();
		System.out.println("While Search Using Inident Number "+ deletedIncidentNumber+"We get following message :"+deletedMessage);
		}
	}
